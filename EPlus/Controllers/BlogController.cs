...
namespace EPlus.Controllers
{
    public class BlogController : Controller
    {
        ...
        // GET: Blog
        public ActionResult Index(int? page_num, string seo_alias, string bc_seo_alias)
        {
            ViewBag.BlogCategory = bc_provider.getBySeoAlias(bc_seo_alias);
            ViewBag.page_num = page_num;
            return View();
        }

        public PartialViewResult GetBlog(int? page_num, string bc_seo_alias)
        {
            ...
            list_return = blog_provider.getByCategorySeoAlias(bc_seo_alias);
