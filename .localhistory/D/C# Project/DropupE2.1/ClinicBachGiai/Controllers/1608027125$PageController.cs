...
namespace ClinicBachGiai.Controllers
{
    public class PageController : Controller
    {
        ...
        // GET: Page
        [OutputCache(Duration = 900, VaryByParam = "none", SqlDependency = "SiteCache:product;SiteCache:category;SiteCache:category_product;SiteCache:cart_of_user;SiteCache:cart_product_variation;SiteCache:blog;SiteCache:system_log;SiteCache:store_logo;SiteCache:store_banner;SiteCache:store_slide;SiteCache:store_membership;SiteCache:store_customer_say;SiteCache:store_partner;SiteCache:store_contact")]
        ...
        public async Task<ActionResult> SendMessage(string sender_name, string sender_email, string sender_subject, string sender_phone_number, string sender_message)
        {
