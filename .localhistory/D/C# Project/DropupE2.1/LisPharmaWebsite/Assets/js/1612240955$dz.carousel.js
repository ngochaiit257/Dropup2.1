...
jQuery(document).ready(function() {
	...
	/*  Team Carousel = owl.carousel.js */
    var listNguyenLlieu = $('.list-nguyen-lieu').
        listNguyenLlieu.owlCarousel({
		loop:true,
        margin: 30,
        center: true,
		nav:true,
    ...
    listNguyenLlieu.children().each(function (index) {
    ...
    $(document).on('click', '.owl-item>div', function () {
        listNguyenLlieu.trigger('to.owl.carousel', $(this).data('position'));
    });
