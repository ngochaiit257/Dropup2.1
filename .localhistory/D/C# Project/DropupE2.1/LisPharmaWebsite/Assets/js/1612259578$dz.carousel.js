...
jQuery(document).ready(function() {
	...
	/*  Team Carousel = owl.carousel.js */
    var listNguyenLieu = $('.list-nguyen-lieu').
        listNguyenLieu.owlCarousel({
		loop:true,
        margin: 30,
        center: true,
		nav:true,
    ...
    listNguyenLieu.children().each(function (index) {
        $(this).attr('data-position', index); // NB: .attr() instead of .data()
    });


    $(document).on('click', '.owl-item>div', function () {
        listNguyenLieu.trigger('to.owl.carousel', $(this).data('position'));
    });
