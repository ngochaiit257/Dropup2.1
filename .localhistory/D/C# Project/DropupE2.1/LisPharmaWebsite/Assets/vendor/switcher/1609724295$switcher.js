...
$(function(){		
    ...
    jQuery(".skin-1").on('click',function(){
		...
		jQuery(".logo-center .logo-c").attr("src", "https://samar.dexignzone.com/xhtml/error-404.html");
        return false;
    });
    jQuery(".skin-2").on('click',function(){
        jQuery(".skin").attr("href", "css/skin/skin-2.css");
		jQuery(".logo-dark img").attr("src", "images/logo-2.png");
		jQuery(".logo-white img").attr("src", "https://samar.dexignzone.com/xhtml/error-404.html");
		jQuery(".logo-center .logo-c").attr("src", "https://samar.dexignzone.com/xhtml/error-404.html");
        return false;
    });
...
/* Theme Panel Save */
	...
	themeOption['bgImage'] =['bg1.jpg','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','bgImage_value'];
	themeOption['bgPatten'] =['pt1.jpg','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','https://samar.dexignzone.com/xhtml/error-404.html','bgPatten_value'];
...
jQuery(document).ready(function(){
	jQuery('.theme-panel-save li a, .theme-panel-save li img').on('click', function() {
			...
			//alert(optionData+'_value '+optionValue);
