...
namespace Data.Providers
{
    public class CategoryProvider
    {
        ...
        public List<category> getListBenhNamKhoa()
        {
            try
            {
                return getAll().Where(c => (c.status == true && c.show_datetime <= DateTime.Now) && (c.image != "../Assets/img/category_image/Logo Bach Giai.png" && c.image != "../Assets/img/category_image/BG.png")).ToList();
            }
            catch
            {
                return null;
