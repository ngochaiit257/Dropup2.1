...
namespace Data.Providers
{
    public class ProductProvider
    {
        ...
        public List<product> filterOnClientSiteElysien(string seo_alias, string search_string, string tab_filter, string color, decimal? min_price, decimal? max_price)
        {
            try
            {
                var list_input = new List<product>();
