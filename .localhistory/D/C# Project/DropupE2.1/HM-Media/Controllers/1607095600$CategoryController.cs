...
namespace HM_Media.Controllers
{
    public class CategoryController : Controller
    {
        ...
        // GET: Category
        public ActionResult Index(int? page_num, long? category_id, string select_order, string search_string, string tab_filter, string choose_grid_view,
        ...
        public PartialViewResult GetProductByCategory(int? page_num, long? category_id, string select_order, string search_string, string tab_filter, string choose_grid_view,
                                    string color, decimal? min_price, decimal? max_price)
        {
