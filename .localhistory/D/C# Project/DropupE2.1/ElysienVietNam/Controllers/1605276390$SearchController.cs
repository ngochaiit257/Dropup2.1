...
namespace ElysienVietNam.Controllers
{
    public class SearchController : Controller
    {
        ...
        // GET: Search
        public ActionResult Index(int? page_num, string keyword, string select_order, string search_string, string tab_filter, string choose_grid_view,
                                    string color, decimal? min_price, decimal? max_price)
        {
            ...
            ViewBag.NumberAllResult = product_provider.searchOnClientSiteMorcar(keyword, (decimal)min_price, (decimal)max_price).Count();
        ...
        public PartialViewResult GetProductBySearchString(int? page_num, string keyword, string select_order, string search_string, string tab_filter, string choose_grid_view,
                                    string color, decimal? min_price, decimal? max_price)
        {
            ...
            ViewBag.MaxPrice = max_price;
            ViewBag.SearchString = keyword;
            list_return = product_provider.searchOnClientSiteMorcar(keyword, (decimal)min_price, (decimal)max_price); ;
