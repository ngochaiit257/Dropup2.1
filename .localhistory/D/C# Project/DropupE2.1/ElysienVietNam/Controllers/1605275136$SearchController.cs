...
namespace ElysienVietNam.Controllers
{
    public class SearchController : Controller
    {
                                    ...
                                    string color, decimal? min_price, decimal? max_price)
        {
            ...
            ViewBag.NumberAllResult = product_provider.product_provider.filterOnClientSite(seo_alias, search_string, tab_filter, color, (decimal)min_price, (decimal)max_price).Count();
