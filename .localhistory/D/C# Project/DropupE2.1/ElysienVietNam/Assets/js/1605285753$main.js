 ...
 /*----------------------------
  ...
  $(window).scroll(function () {
    ...
    if (window_top > 50) {
        ...
        $('.main-navigation ul li .a-submenu').css('color','#000');
        $('.header_account_list a').css('color','#000');
        $('.count-cart').css('color', '#000');

        $('.mean-container a.meanmenu-reveal span').css('background', '#000');
        $('.mean-container a.meanmenu-reveal').css('border', '1px solid #000');
        $('.img-logo').removeClass('brightness');
    } else {
        $('.sticky-nav').removeClass('menu_fixed animated fadeInDown');
        $('.main-navigation ul li .a-submenu').css('color', '#fff');
        $('.header_account_list a').css('color', '#fff');
        $('.count-cart').css('color', '#fff');
        
        $('.mean-container a.meanmenu-reveal span').css('background', '#fff');
        $('.mean-container a.meanmenu-reveal').css('border', '1px solid #fff');
        $('.mean-container a.meanmenu-reveal').css('border', '1px solid #fff');
        $('.img-logo').addClass('brightness');
    }
  });
