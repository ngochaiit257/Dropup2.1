            ...
            return s(t, [{
                ...
                value: function (t, e) {
                    var i = e.blur,
                        ...
                        n = e.color,
                        r = e.opacity,
                        o = t.flood(n, r).composite(t.sourceAlpha, "in").offset(a, s).gaussianBlur(i).merge(t.source);
                    return t.blend(t.source, o)
                }
            }, {
                key: "dropShadow",
                value: function (t, e) {
                    var i = e.top,
                        ...
                        n = e.color,
                        r = e.opacity,
                        o = e.noUserSpaceOnUse;
                    return t.unfilter(!0), (new window.SVG.Filter).size("120%", "180%", "-5%", "-40%"), t.filter(function (t) {
                        var e = null;
                        e = d.isSafari() || d.isFirefox() || d.isIE() ? t.flood(n, r).composite(t.sourceAlpha, "in").offset(s, i).gaussianBlur(a) : t.flood(n, r).composite(t.sourceAlpha, "in").offset(s, i).gaussianBlur(a).merge(t.source), t.blend(t.source, e)
                    }), o || t.filterer.node.setAttribute("filterUnits", "userSpaceOnUse"), t
                }
            }, {
                ...
                value: function (t, e, i) {
                    ...
                    if (void 0 !== s.globals.selectedDataPoints[e] && s.globals.selectedDataPoints[e].indexOf(i) > -1) {
                        ...
                        "none" !== a && this.applyFilter(t, a.type, a.value)
                    }
                }
            }]), t
        }(),
        ...
        f = function () {
            ...
            return s(t, [{
                ...
                value: function (t) {
                    ...
                    if (T.attr("id", "".concat(m, "-").concat(i)), T.attr("index", a), y && T.attr({
        ...
        b = function () {
            ...
            return s(t, [{
                ...
                value: function (t, e, i) {
                    ...
                    } else a = (t.x - s.globals.minX) / (s.globals.xRange / s.globals.gridWidth), n = s.globals.gridHeight - (parseFloat(t.y) - s.globals.minYArr[t.yAxisIndex]) / (s.globals.yRange[t.yAxisIndex] / s.globals.gridHeight) - parseInt(t.label.style.fontSize) - t.marker.size, r = s.globals.gridHeight - (t.y - s.globals.minYArr[t.yAxisIndex]) / (s.globals.yRange[t.yAxisIndex] / s.globals.gridHeight);
                ...
                value: function (t, e, i) {
                    ...
                    var E = P.bbox(),
                        T = this.graphics.drawRect(E.x - v, E.y - C, E.width + v + w, E.height + A + C, x, g, 1, f, b, p);
            ...
            return s(i, [{
                ...
                value: function () {
                    ...
                    if (e && "object" === t(e)) {
                        ...
                        "line" !== e.chart.type && "area" !== e.chart.type && "scatter" !== e.chart.type || o.comboChartsHasBars || "datetime" === e.xaxis.type || "on" !== e.xaxis.tickPlacement || s.convertCatToNumeric(), (e.chart.sparkline && e.chart.sparkline.enabled || window.Apex.chart && window.Apex.chart.sparkline && window.Apex.chart.sparkline.enabled) && (r = s.sparkline(r)), n = d.extend(a, r)
                    }
                    ...
                    if (n.globals.markers.size[e] > 0 && (o = l.group({
                        ...
                        for (var h = function (t) {
                            ...
                            if ("line" !== n.config.chart.type && "area" !== n.config.chart.type || n.globals.comboCharts || n.config.tooltip.intersect || (c += " no-pointer-events"), Array.isArray(n.config.markers.size) ? n.globals.markers.size[e] > 0 : n.config.markers.size > 0) {
                                ...
                                var g = a.getMarkerConfig(c, e);
                                n.config.markers.discrete.map(function (t) {
                                    t.seriesIndex === e && t.dataPointIndex === h && (g.pointStrokeColor = t.strokeColor, g.pointFillColor = t.fillColor, g.pSize = t.size)
                                }), (s = l.drawMarker(r.x[t], r.y[t], g)).attr("rel", h), s.attr("j", h), s.attr("index", e), s.node.setAttribute("default-marker-size", g.pSize), new u(a.ctx).setSelectionFilter(s, e, h), a.addEvents(s), o && o.add(s)
            ...
            return s(t, [{
                ...
                value: function (t, e, i) {
                    ...
                    if (x.attr("clip-path", "url(#gridRectMarkerMask".concat(s.globals.cuid, ")")), h.x instanceof Array)
                        for (var b = 0; b < h.x.length; b++) {
                            var m = e + 1;
                            0 === e && 0 === b && (m = 0), 0 === e && 1 === b && (m = 1);
                            var v = 0,
                                y = s.globals.markers.size[l];
                            c !== 1 / 0 && (y = s.globals.seriesZ[l][m] / c, void 0 === this.radiusSizes[l] && this.radiusSizes.push([]), this.radiusSizes[l].push(y)), s.config.chart.animations.enabled || (v = y);
                            var w = h.x[b],
                                k = h.y[b];
                            if (k = k || 0, v = v || 0, 0 === (w = w || 0) && 0 === k || void 0 === s.globals.series[l][m]) return;
                            ...
                            if (C.attr({
                                ...
                                color: s.config.chart.dropShadow.color,
                                opacity: s.config.chart.dropShadow.opacity
                            ...
                            r.setSelectionFilter(C, l, m), Y.addEvents(C), C.node.classList.add("apexcharts-marker"), x.add(C), d.add(x)
                        }
                }
            }, {
            ...
            return s(t, [{
                ...
                value: function (t, e) {
                    ...
                    for (var l = function (r, l) {
                        ...
                        x = S.y, w = S.barHeight, c = S.yDivision, u = S.zeroW, p = S.x, k = S.barWidth, h = S.xDivision, d = S.zeroH, i.horizontal || m.push(p + k / 2);
                        for (var C = a.group({
                            ...
                            o = i.isHorizontal ? i.drawBarPaths({
                                ...
                                strokeWidth: A,
                                elSeries: y
                            }), g = o.pathTo, f = o.pathFrom, x = o.y, p = o.x, e > 0 && m.push(p + k / 2), b.push(x);
                        ...
                        s.globals.seriesXvalues[v] = m, s.globals.seriesYvalues[v] = b, o.add(y)
                ...
                value: function (t) {
                    var e = t.realIndex,
                        ...
                        y = this.w,
                        w = new f(this.ctx);
                    s || (s = y.globals.stroke.colors[e]), this.isNullValue && (i = "none");
                    ...
                    new u(this.ctx).setSelectionFilter(A, e, a), h.add(A);
                ...
                value: function (t) {
                    ...
                    var v = {
                        ...
                        y = this.barEndingShape(d, v, this.series, g, p);
                    if (n = n + u.line(m, y.newY) + y.path + u.line(m + o - h, l) + u.line(m, l), r = r + u.line(m, l) + y.ending_p_from + u.line(m + o - h, l) + u.line(m + o - h, l) + u.line(m, l), d.globals.isXNumeric || (i += a), this.barOptions.colors.backgroundBarColors.length > 0 && 0 === g) {
                        b >= this.barOptions.colors.backgroundBarColors.length && (b = 0);
                        var w = this.barOptions.colors.backgroundBarColors[b],
                ...
                value: function (t) {
                    ...
                    var b = !!(r > i.globals.gridHeight - this.baseLineY[this.yaxisIndex] && 0 !== Math.abs(this.baseLineY[this.yaxisIndex])),
                        m = 0 !== Math.abs(i.globals.minYArr[n]);
                    switch (d.position) {
                        case "center":
                            c = r + p / 2 + h.height / 2 - f, m && (c = b ? r + p / 2 + h.height / 2 + f : r + p / 2 + h.height / 2 - f);
                            break;
                        case "bottom":
                            c = m ? b ? r + p + h.height + u + f : r + p - h.height / 2 + u - f : i.globals.gridHeight - h.height / 2 - f;
                            break;
                        case "top":
                            c = m && b ? r - h.height / 2 - f : r + h.height + f
                    }
                    return {
                        bcx: o,
                        bcy: r,
            ...
            return r(i, z), s(i, [{
                ...
                value: function (t, e) {
                    ...
                    for (var o = 0, l = 0, h = function (a, n) {
                        ...
                        var m, v, y = i.graphics.group({
                            class: "apexcharts-series ".concat(s.globals.seriesNames[b].toString().replace(/ /g, "-")),
                            rel: a + 1,
                            "data:realIndex": b
                        }),
                            w = i.graphics.group({
                        ...
                        l = A.y, m = A.barHeight, u = A.yDivision, f = A.zeroW, o = A.x, v = A.barWidth, d = A.xDivision, g = A.zeroH, i.yArrj = [], i.yArrjF = [], i.yArrjVal = [], i.xArrj = [], i.xArrjF = [], i.xArrjVal = [];
                        for (var S = function (e) {
                            s.config.stroke.show && (k = i.isNullValue ? 0 : Array.isArray(i.strokeWidth) ? i.strokeWidth[b] : i.strokeWidth);
                            var r = null;
                            ...
                            var C = i.fill.fillPath(y, {
                                seriesNumber: i.barOptions.distributed ? A : b,
                                color: S
                            });
                            y = i.renderSeries({
                                realIndex: b,
                        ...
                        s.globals.seriesXvalues[b] = p, s.globals.seriesYvalues[b] = x, i.prevY.push(i.yArrj), i.prevYF.push(i.yArrjF), i.prevYVal.push(i.yArrjVal), i.prevX.push(i.xArrj), i.prevXF.push(i.xArrjF), i.prevXVal.push(i.xArrjVal), r.add(y)
                ...
                value: function (t) {
                    ...
                    if (f > 0) {
                        var y = o;
                        this.prevXVal[f - 1][p] < 0 ? y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] + m : this.prevX[f - 1][p] : this.prevXVal[f - 1][p] >= 0 && (y = this.series[f][p] >= 0 ? this.prevX[f - 1][p] : this.prevX[f - 1][p] - m), e = y
                    } else e = o;
                ...
                value: function (t) {
                    ...
                    if (u > 0 && !d.globals.isXNumeric || u > 0 && d.globals.isXNumeric && d.globals.seriesX[u - 1][g] === d.globals.seriesX[u][g]) {
                        ...
                        b = this.prevYVal[u - 1][g] < 0 ? this.series[u][g] >= 0 ? w - v : w : this.series[u][g] >= 0 ? w : w + v
                    } else b = d.globals.gridHeight - l;
                    s = (this.series[u][g], b - this.series[u][g] / this.yRatio[this.yaxisIndex]);
                    var k = {
                        barWidth: o,
                        strokeWidth: h,
        ...
        P = function (t) {
            ...
            return r(i, z), s(i, [{
                ...
                value: function (t, e) {
                    ...
                    for (var o = 0, l = 0; o < t.length; o++ , l++) {
                        var h, c, d = void 0,
                            ...
                            y = s.group({
                                class: "apexcharts-series ".concat(i.globals.seriesNames[m].toString().replace(/ /g, "-")),
                                rel: o + 1,
                                "data:realIndex": m
                            });
                        ...
                        p = C.y, w = C.barHeight, g = C.x, k = C.barWidth, h = C.xDivision, c = C.zeroH, b.push(g + k / 2);
                        for (var L = s.group({
                            class: "apexcharts-datalabels"
                        }), z = 0, M = i.globals.dataPoints; z < i.globals.dataPoints; z++ , M--) {
                            void 0 === this.series[o][z] || null === t[o][z] ? this.isNullValue = !0 : this.isNullValue = !1, i.config.stroke.show && (S = this.isNullValue ? 0 : Array.isArray(this.strokeWidth) ? this.strokeWidth[m] : this.strokeWidth);
                            ...
                            d = E.pathTo, u = E.pathFrom, p = E.y, g = E.x, P = E.color, z > 0 && b.push(g + k / 2), x.push(p);
                            var T = a.fillPath(y, {
                                seriesNumber: m,
                                color: P
                            }),
                        ...
                        i.globals.seriesXvalues[m] = b, i.globals.seriesYvalues[m] = x, r.add(y)
                    }
                    return r
                }
            }, {
                ...
                value: function (t) {
                    ...
                    return c.move(S, o), n = c.move(S, o), h.globals.previousPaths.length > 0 && (n = this.getPathFrom(m, u, !0)), void 0 === this.series[d][u] || null === this.series[d][u] ? k = o : (k = o - k / b, A = o - A / b, y = o - v.h / b, w = o - v.l / b), a = c.move(S, A) + c.line(S + r / 2, A) + c.line(S + r / 2, y) + c.line(S + r / 2, A) + c.line(S + r, A) + c.line(S + r, k) + c.line(S + r / 2, k) + c.line(S + r / 2, w) + c.line(S + r / 2, k) + c.line(S, k) + c.line(S, A - l / 2), h.globals.isXNumeric || (i += s), {
                        pathTo: a,
                        pathFrom: n,
                        x: i,
                        y: A,
            ...
            return s(t, [{
                ...
                value: function () {
                    ...
                    if (t.config.xaxis.crosshairs.show) {
                        "gradient" === n && (y = e.drawGradient("vertical", r, o, l, h, null, c));
                        var w = e.drawRect();
                    ...
                    for (var a = e.globals.gridWidth / e.globals.dataPoints, n = e.globals.gridHeight / e.globals.series.length, r = 0, o = t.length - 1; o >= 0; o--) {
                        ...
                        for (var c = 0, g = 0; g < t[o].length; g++) {
                            ...
                            if (e.config.plotOptions.heatmap.enableShades) {
                                var v = new d;
                                m = d.hexToRgba(v.shadeColor(p, x.color), e.config.fill.opacity)
                            }
                            ...
                            if (e.globals.dataChanged) {
                                ...
                                if (this.dynamicAnim.enabled && e.globals.shouldAnimate) {
                                    ...
                                    S || (S = "rgba(255, 255, 255, 0)"), this.animateHeatColor(w, d.isColorHex(S) ? S : d.rgb2hex(S), d.isColorHex(m) ? m : d.rgb2hex(m), A)
                                }
                            }
                ...
                value: function (t) {
                    ...
                    for (var v = m ? t.series.length - 1 : 0; m ? v >= 0 : v < t.series.length; m ? v-- : v++) {
                        ...
                        var w = s.fillPath(y, {
                            ...
                            M = void 0;
                        e.globals.dataChanged && (S = this.startAngle, M = Math.round(C * d.negToZero(e.globals.previousPaths[v]) / 100) + S), Math.abs(z) + Math.abs(k) >= 360 && (z -= .01), Math.abs(M) + Math.abs(S) >= 360 && (M -= .01);
                        var P = z - k,
                        ...
                        var F = 0;
                        !I.initialAnim || e.globals.resized || e.globals.dataChanged || (F = (z - k) / 360 * e.config.chart.animations.speed, this.animDur = F / (1.2 * t.series.length) + this.animDur, this.animBeginArr.push(this.animDur)), e.globals.dataChanged && (F = (z - k) / 360 * e.config.chart.animations.dynamicAnimation.speed, this.animDur = F / (1.2 * t.series.length) + this.animDur, this.animBeginArr.push(this.animDur)), I.animatePaths(T, {
                            centerX: t.centerX,
                            centerY: t.centerY,
                            endAngle: z,
                            startAngle: k,
        ...
        O = function () {
            ...
            return s(t, [{
                ...
                value: function (t, e, i) {
                    ...
                    c = h.getLogYRatios(c);
                    for (var u = this.xyRatios.zRatio, g = this.xyRatios.xRatio, p = this.xyRatios.baseLineY, x = [], b = [], m = 0, y = 0; y < t.length; y++) {
                        ...
                        var C = [],
                            ...
                            P = M;
                        M > s.globals.gridHeight && (P = s.globals.gridHeight), m = w / 2;
                        var E = s.globals.padHorizontal + m,
                            T = 1;
                        ...
                        for (var Z = s.globals.dataPoints > 1 ? s.globals.dataPoints - 1 : s.globals.dataPoints, $ = 0; $ < Z; $++) {
                            ...
                            s.config.chart.stacked ? (j = y > 0 && s.globals.collapsedSeries.length < s.config.series.length - 1 ? b[y - 1][$ + 1] : M, T = void 0 === t[y][$ + 1] || null === t[y][$ + 1] ? j - J / c[this.yaxisIndex] : j - t[y][$ + 1] / c[this.yaxisIndex]) : T = void 0 === t[y][$ + 1] || null === t[y][$ + 1] ? M - J / c[this.yaxisIndex] : M - t[y][$ + 1] / c[this.yaxisIndex], z.push(E), C.push(T);
                        ...
                        b.push(C), s.globals.seriesXvalues[k] = z, s.globals.seriesYvalues[k] = C, this.pointsChart || s.globals.delayedElements.push({
                            el: R.node,
                            index: k
                        });
                        var st = {
                ...
                value: function (t) {
                    ...
                    if ("smooth" === b) {
                        var m = .35 * (a - r);
                        p.globals.hasNullValues ? (null !== e[i][s] && (null !== e[i][s + 1] ? (c = x.move(r, o) + x.curve(r + m, o, a - m, n, a + 1, n), d = x.move(r + 1, o) + x.curve(r + m, o, a - m, n, a + 1, n) + x.line(a, h) + x.line(r, h) + "z") : (c = x.move(r, o), d = x.move(r, o) + "z")), u.push(c), g.push(d)) : (c += x.curve(r + m, o, a - m, n, a, n), d += x.curve(r + m, o, a - m, n, a, n)), r = a, o = n, s === e[i].length - 2 && (d = d + x.curve(r, o, a, n, a, h) + x.move(a, n) + "z", p.globals.hasNullValues || (u.push(c), g.push(d)))
                ...
                value: function (t) {
                    for (var e = t.pathFromLine, i = t.pathFromArea, s = t.realIndex, a = this.w, n = 0; n < a.globals.previousPaths.length; n++) {
                        ...
                        ("line" === r.type || "area" === r.type) && r.paths.length > 0 && parseInt(r.realIndex) === parseInt(s) && ("line" === r.type ? (this.appendPathFrom = !1, e = a.globals.previousPaths[n].paths[0].d) : "area" === r.type && (this.appendPathFrom = !1, a.config.stroke.show ? (e = a.globals.previousPaths[n].paths[0].d, i = a.globals.previousPaths[n].paths[1].d) : i = a.globals.previousPaths[n].paths[0].d))
                    }
                    return {
                        pathFromLine: e,
                        pathFromArea: i
            ...
            return s(t, [{
                ...
                value: function (t, e) {
                    ...
                    if (i.config.yaxis[e].labels.show)
                        for (var u = l; u >= 0; u--) {
                            ...
                            g = d(g, u);
                            var p = i.config.yaxis[e].labels.padding;
                            i.config.yaxis[e].opposite && 0 !== i.config.yaxis.length && (p *= -1);
                            var x = s.drawText({
                                x: p,
                            ...
                            0 !== i.config.yaxis[e].labels.rotate && x.node.setAttribute("transform", "rotate(".concat(i.config.yaxis[e].labels.rotate, " ").concat(b.x, " ").concat(b.y, ")")), c += h
                        }
                ...
                value: function (t, e, i, s) {
                    ...
                    return void 0 === a.config.yaxis[t].title.text || t < 0 ? {
                        xPos: r,
                        padd: 0
                    } : (s ? (r = e.width + a.config.yaxis[t].title.offsetX + i.width / 2 + o / 2, 0 === (n += 1) && (r -= o / 2)) : (r = -1 * e.width + a.config.yaxis[t].title.offsetX + o / 2 + i.width / 2, this.isBarHorizontal && (o = 25, r = -1 * e.width - a.config.yaxis[t].title.offsetX - o)), {
                        xPos: r,
                        padd: o
                    })
                }
                ...
                value: function (t, e) {
                    ...
                    i.config.yaxis.length > 1 && (this.multipleYs = !0), i.config.yaxis.map(function (o, l) {
                        ...
                        o.opposite ? (a = i.globals.gridWidth + i.globals.translateX + r, h || (r = r + c + 20), i.globals.translateYAxisX[l] = a - o.labels.offsetX + 20) : (s = i.globals.translateX - n, h || (n = n + c + 20), i.globals.translateYAxisX[l] = s + o.labels.offsetX)
                    })
                }
            }]), t
        }(),
            ...
            return s(t, [{
                ...
                value: function () {
                    ...
                    if (e.config.xaxis.labels.show)
                        for (var d = 0; d <= c - 1; d++) {
                            ...
                            a.add(b), i.addTspan(b, g, this.xaxisFontFamily);
                            var m = document.createElementNS(e.globals.svgNS, "title");
                            m.textContent = g, b.node.appendChild(m), n += t
                        }
                    if (void 0 !== e.config.xaxis.title.text) {
                        var v = i.group({
                ...
                value: function (t) {
                    ...
                    if (s.config.xaxis.axisBorder.show) {
                        ...
                        n.add(b), new D(this.ctx).drawAxisTicks(0, o.length, s.config.yaxis[0].axisBorder, s.config.yaxis[0].axisTicks, 0, e, n)
                    }
                    return n
                }
            }, {
        ...
        H = function () {
            ...
            return s(t, [{
                ...
                value: function (t, e) {
                    ...
                    if (t === Number.MIN_VALUE && 0 === e || !d.isNumber(t) && !d.isNumber(e)) return t = 0, e = 1, s = 1, this.linearScale(t, e, s);
                    t > e ? (console.warn("yaxis.min cannot be greater than yaxis.max"), e = t + .1) : t === e && (t = 0 === t ? 0 : t - .1, e = 0 === e ? 2 : e + .1);
                    var a = [],
                        n = s + 1;
                    n < 2 ? n = 2 : n > 2 && (n -= 2);
                    for (var r = (e - t) / n, o = Math.floor(d.log10(r)), l = Math.pow(10, o), h = parseInt(r / l) * l, c = h * Math.floor(t / h), u = h * Math.ceil(e / h), g = c; a.push(g), !((g += h) > u););
                    if (void 0 === this.w.config.yaxis[i].max && void 0 === this.w.config.yaxis[i].min || this.w.config.yaxis[i].forceNiceScale) return {
                        result: a,
                        niceMin: a[0],
                    ...
                    var f = t;
                    (a = []).push(f);
                    for (var p = Math.abs(e - t) / s, x = 0; x <= s - 1; x++) f += p, a.push(f);
                    return {
                        result: a,
                        niceMin: a[0],
                        niceMax: a[a.length - 1]
            ...
            return s(t, [{
                ...
                value: function () {
                    ...
                    if (("line" === e.chart.type || "area" === e.chart.type || "candlestick" === e.chart.type) && t.minY === Number.MIN_VALUE && s !== Number.MAX_SAFE_INTEGER) {
                        var p = t.maxY - s;
                        s >= 0 && s <= 10 && (p = 0), t.minY = s - 5 * p / 100, t.maxY = t.maxY + 5 * p / 100 + .01
                    }
        ...
        _ = function () {
            ...
            return s(t, [{
                ...
                value: function (t, e) {
                    ...
                    return m.filter(function (t) {
                        var e = 1,
                            ...
                            n = t.value;
                        void 0 !== s.config.xaxis.tickAmount && (a = s.config.xaxis.tickAmount), m.length > a && (e = Math.floor(m.length / a));
                        var r = !1,
                            o = !1;
                ...
                value: function (t) {
                    ...
                    for (var x = o + 1, b = l, m = 0, v = 1; m < r; m++ , v++) {
                    ...
                    if (!(!e.config.plotOptions.bar.horizontal || "bar" !== e.config.chart.type)) {
                        ...
                        if (e.config.grid.yaxis.lines.show)
                            for (var u = 0, g = 0, p = e.globals.gridWidth, x = 0; x < e.globals.dataPoints + 1; x++) {
                                var b = i.drawLine(0, u, p, g, e.config.grid.borderColor, s);
                                a.add(b), b.node.classList.add("apexcharts-gridline"), this.animY && this.animateLine(b, {
                                    y1: u + 20,
                                    y2: g + 20
                                }, {
                                        y1: u,
                        ...
                        if (t = this.xaxisLabels.length, e.config.grid.xaxis.lines.show || e.config.xaxis.axisTicks.show) {
                            var m, v = e.globals.padHorizontal,
                                y = e.globals.gridHeight;
                            if (e.globals.timelineLabels.length > 0)
                                for (var w = 0; w < t; w++) {
                                    if (v = this.xaxisLabels[w].position, m = this.xaxisLabels[w].position, e.config.grid.xaxis.lines.show && v > 0 && v < e.globals.gridWidth) {
                                        var k = i.drawLine(v, 0, m, y, e.config.grid.borderColor, s);
                                ...
                                for (var A = t, S = 0; S < A; S++) {
                                    var C = A;
                                    if (e.globals.isXNumeric && "bar" !== e.config.chart.type && (C -= 1), m = v += e.globals.gridWidth / C, S === C - 1) break;
                                    if (e.config.grid.xaxis.lines.show) {
                                        var L = i.drawLine(v, 0, m, y, e.config.grid.borderColor, s);
                ...
                value: function () {
                    ...
                    for (var n = t.globals.legendFormatter, r = 0; r <= i.length - 1; r++) {
                        ...
                        var d = t.config.legend.markers.offsetX,
                            ...
                            y = c.style;
                        y.background = s[r], y.color = s[r], y.height = Array.isArray(g) ? parseFloat(g[r]) + "px" : parseFloat(g) + "px", y.width = Array.isArray(p) ? parseFloat(p[r]) + "px" : parseFloat(p) + "px", y.left = Array.isArray(d) ? d[r] : d, y.top = Array.isArray(u) ? u[r] : u, y.borderWidth = Array.isArray(x) ? x[r] : x, y.borderColor = Array.isArray(b) ? b[r] : b, y.borderRadius = Array.isArray(m) ? parseFloat(m[r]) + "px" : parseFloat(m) + "px", t.config.legend.markers.customHTML && (Array.isArray(t.config.legend.markers.customHTML) ? c.innerHTML = t.config.legend.markers.customHTML[r]() : c.innerHTML = t.config.legend.markers.customHTML()), f.setAttrs(c, {
                            rel: r + 1,
                            "data:collapsed": l
            ...
            return s(t, [{
                ...
                value: function (t) {
                    ...
                    if (c.contains("apexcharts-bar-area") || c.contains("apexcharts-candlestick-area")) {
                        ...
                        }), s.config.tooltip.followCursor ? s.config.plotOptions.bar.horizontal ? (o = m - g.left + 15, l = b - n.dataPointsDividedHeight + f / 2 - n.tooltipRect.ttHeight / 2) : (o = s.globals.isXNumeric ? x - p / 2 : x - n.dataPointsDividedWidth + p / 2, l = e.clientY - g.top - n.tooltipRect.ttHeight / 2 - 15) : s.config.plotOptions.bar.horizontal ? ((o = x) < n.xyRatios.baseLineInvertedY && (o = x - n.tooltipRect.ttWidth), l = b - n.dataPointsDividedHeight + f / 2 - n.tooltipRect.ttHeight / 2) : (o = s.globals.isXNumeric ? x - p / 2 : x - n.dataPointsDividedWidth + p / 2, l = b)
                    }
                    return {
                        x: o,
                        y: l,
            ...
            return s(t, [{
                ...
                value: function (t) {
                    for (var e = this.w, i = [], s = this.getElTooltip(), a = 0; a < t; a++) {
                        ...
                        var c = document.createElement("span");
                        c.classList.add("apexcharts-tooltip-text-value", "showNumeric"), l.appendChild(c);
                ...
                value: function (t) {
                    ...
                    if (this.clientY = c, this.clientX = h, c < l.top || c > l.top + l.height) this.handleMouseOut(n);
                        ...
                        var d = this.getElTooltip(),
                            ...
                            g = r.globals.xyCharts || "bar" === r.config.chart.type && !this.isBarHorizontal && this.hasBars() && r.config.tooltip.shared || r.globals.comboCharts && this.hasBars;
                        if ("bar" === r.config.chart.type && this.isBarHorizontal && this.hasBars() && (g = !1), "mousemove" === a.type || "touchmove" === a.type) {
                            if (null !== u && u.classList.add("active"), null !== this.ycrosshairs && this.blyaxisTooltip && this.ycrosshairs.classList.add("active"), g && !this.showOnIntersect) {
                                ...
                                if (null !== f) {
                                    ...
                                    void 0 !== r.globals.series[f][e] ? r.config.tooltip.shared && this.tooltipUtil.isXoverlap(e) && this.tooltipUtil.isinitialSeriesSameLen() ? this.create(this, f, e, n.ttItems) : this.create(this, f, e, n.ttItems, !1) : this.tooltipUtil.isXoverlap(e) && this.create(this, 0, e, n.ttItems)
        ...
        xt = function (t) {
            ...
            return r(i, pt), s(i, [{
                ...
                value: function (t, e, i) {
                    ...
                    s.config.chart.zoom.autoScaleYaxis && (n = new H(me.ctx).autoScaleY(me.ctx, {
                        xaxis: r
                    }));
        ...
        function () {
            ...
            function s(t) {
                ...
                switch (t[0]) {
                    ...
                    case "A":
                        t = (e = function (t, e) {
                            var i, s, a, n, r, o, l, h, c, d, u, g, f, p, x, b, m, v, y, w, k, A, S, C, L, z, M = Math.abs(e[1]),
                                P = Math.abs(e[2]),
                                E = e[3] % 360,
                                T = e[4],
                                X = e[5],
                                ...
                                O = new SVG.Point(Y, I),
                                D = [];
                            if (0 === M || 0 === P || F.x === O.x && F.y === O.y) return [
                            ...
                            for (b[0][0] = b[0][1].clone(), b[b.length - 1][2] = b[b.length - 1][1].clone(), a = (new SVG.Matrix).rotate(E).scale(M, P).rotate(-E), k = 0, A = b.length; k < A; k++) b[k][0] = b[k][0].transform(a), b[k][1] = b[k][1].transform(a), b[k][2] = b[k][2].transform(a);
                            for (k = 1, A = b.length; k < A; k++) w = b[k - 1][2], S = w.x, C = w.y, w = b[k][0], L = w.x, z = w.y, w = b[k][1], Y = w.x, I = w.y, D.push(["C", S, C, L, z, Y, I]);
                            return D
                        }(this.pos, t))[0]
                }
